...
const WidgetHeader = React.forwardRef(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
...
const WidgetTitle = React.forwardRef(({ className, ...props }, ref) => (
    <h5
        ref={ref}
...
const WidgetContent = React.forwardRef(({ className, ...props }, ref) => (
    <div
        ref={ref}
...
const WidgetFooter = React.forwardRef(({ className, ...props }, ref) => (
    <div
        ref={ref}
